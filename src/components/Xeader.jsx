        ...
        <header className={`${data.Container} py-2 sticky top-0 overflow-hidden bg-[#171818] border-b rounded-b-sm border-blue-500 z-50`}>
            ...
            >
                ...
                <nav className="flex flex-col p-5 gap-4">
                    ...
                    <NavLink to="/" className='border text-center py-2 rounded-lg font-semibold border-white/50 bg-black hover:bg-blue-700 hover:border-blue-500 transition-all duration-200' onClick={() => setMenuOpen(false)}>
                        Seriallar
                    </NavLink>
                    <NavLink to="/" className='border text-center py-2 rounded-lg font-semibold border-white/50 bg-black hover:bg-blue-700 hover:border-blue-500 transition-all duration-200' onClick={() => setMenuOpen(false)}>
                        Animelar
