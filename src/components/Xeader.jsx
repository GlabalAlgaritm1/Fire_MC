                ...
                <header className={`${data.Container}`}>
                    <section className='flex items-center justify-between'>
                        ...
                        <section className='flex items-center gap-x-4'>
                            <button className='border px-4 py-1 rounded-lg text-green-600 font-semibold border-green-600 hover:bg-green-600 hover:text-white hover:border-green-700 hover:transition-all hover:duration-200 max-sm:hidden'>
                                Follow
                            </button>
                            <NavLink to='/search' className='border px-3 py-1 rounded-lg text-white hover:border-blue-500 hover:bg-blue-500 transition-all duration-200 flex items-center gap-x-2'>
                                <img width={24} height={24} src={images.searchicon} alt="" /> <span className='font-semibold max-sm:hidden'>Search</span>
                            </NavLink>
